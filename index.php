...
define('DB_USER', getenv('TODOLIST_BD_USER'));
define('DB_PASS', getenv('TODOLIST_DB_PASS'));
define('DB_NAME', getenv('TODOLIST_BD_NAME'));
define('DB_HOST', getenv('TODLIST_BD_HOST'));
define('DB_PORT', getenv('TODLIST_BD_PORT'));
